    ...
    public partial class RoomProperties : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomPropertiesPropertyId = table.Column<int>(type: "int", nullable: false),
                    RoomsRoomId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomRoomProperty", x => new { x.RoomPropertiesPropertyId, x.RoomsRoomId });
                    table.ForeignKey(
                        name: "FK_RoomRoomProperty_RoomProperties_RoomPropertiesPropertyId",
                        column: x => x.RoomPropertiesPropertyId,
